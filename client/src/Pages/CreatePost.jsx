...
import { useCreateBlogPostMutation } from '../slices/apiSlice';
...
const CreatePost = () => {
  ...
  const [createBlogPost, {isLoading, isError, error}] = useCreateBlogPostMutation()
  const handleSubmit = async(e)=>{
    ...
    try {
        const res = await createBlogPost(formData).unwrap()
        console.log(res);
